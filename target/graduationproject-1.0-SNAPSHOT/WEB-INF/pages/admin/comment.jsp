    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
				...
				{field: 'content', width: 500, title: '评论内容',edit:'text',align:'center'},
                {field: 'goodsId', width: 120, title: '评论物品ID',align:'center'},
				{field: 'userId', width: 120, title: '评论者ID',align:'center'},
				{field: 'createAt', width: 160, sort: true,title: '评论时间',edit:'text',align:'center'},
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['60%', '65%'],
                    content: '<%=basePath%>admin/comment/editPage?id=' + data.id
                });
                $(window).on("resize", function () {
                    layer.full(index);
                });
                ...
                layer.confirm('确定删除id为'+ data.id +'的评论么？', function (index) {
                    obj.del();
                    layer.close(index);
					
					$.ajax({
						url: "<%=basePath%>admin/comment/delete",
						data: {id:data.id},
						type: "post",
						dataType: "json",
		...
		table.on('edit(currentTableFilter)', function(obj){
            ...
            $.ajax({
                url: "<%=basePath%>admin/comment/updateField",
