        ...
        <div class="layui-form login-form">
            <form class="layui-form" action="">
                <div class="layui-form-item logo-title">
                    <h1 style="font-size: 23px">闲置物品交易网站后台登录</h1>
                </div>
                <div class="layui-form-item">
                    <label class="layui-icon layui-icon-username" for="username"></label>
                    <input type="text" name="phone" lay-verify="required|account" placeholder="手机号" autocomplete="off" class="layui-input" value="">
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="captcha-img">
                        <img id="captchaPic" src="<%=basePath%>layui_mini2/images/captcha.jpg">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script src="<%=basePath%>layui_mini2/lib/jquery-3.4.1/jquery-3.4.1.min.js" charset="utf-8"></script>
<script src="<%=basePath%>layui_mini2/lib/layui-v2.5.5/layui.js" charset="utf-8"></script>
<script src="<%=basePath%>layui_mini2/lib/jq-module/jquery.particleground.min.js" charset="utf-8"></script>
<script>
