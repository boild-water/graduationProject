        ...
        <div class="layui-col-md3" style="margin-left: 50px">
            ...
            <div class="layui-carousel" id="test10">
                <div carousel-item="">
                    ...
                    <div><img class="myimg" src="<%=basePath%>upload/499afa59-53bc-4d23-99ef-5d0f9d60de69.jpg"></div>
                    <div><img class="myimg" src="<%=basePath%>upload/735f26c0-3db1-4942-8d95-2a7e7c1de3b0.png"></div>
                    <div><img class="myimg" src="https://res.layui.com/images/layui/demo/4.png"></div>
                    <div><img class="myimg" src="https://res.layui.com/images/layui/demo/5.png"></div>
                </div>
            </div>
                ...
                <form class="layui-form" action="" method="post">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="name" lay-verify="name" autocomplete="off" placeholder="请输入物品名称"
                                   class="layui-input">
                        </div>
                        <!-- 提示该项是否为必填项 -->
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            <textarea placeholder="请输入物品描述" name="description" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="text" name="realPrice" lay-verify="realPrice" placeholder="￥" autocomplete="off"
                                       class="layui-input">
                            </div>
                            <!-- 提示该项是否为必填项 -->
                            <div class="layui-form-mid layui-word-aux"><span style="font-size: 18px;color: red;">*</span></div>
                            ...
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="text" name="price" lay-verify="price" placeholder="￥" autocomplete="off" class="layui-input">
                            </div>
                            <!-- 提示该项是否为必填项 -->
                            <div class="layui-form-mid layui-word-aux"><span style="font-size: 18px;color: red;">*</span></div>
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="checkbox" checked="" name="is_bargain" lay-skin="switch"
                                   lay-filter="bargainSwitch" lay-text="是|否">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">物品地址</label>
                        <div class="layui-input-inline" style="width: 160px">
                            <select name="addressDescUtil.campusName" lay-verify="required">
                        ...
                        <div class="layui-input-inline" style="width: 160px">
                            <select name="addressDescUtil.dormitoryBuilding" lay-verify="required">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="checkbox" checked="" name="onSale" lay-skin="switch" lay-filter="onSaleSwitch"
                                   lay-text="是|否">
                        </div>
                    </div>
                        ...
                        <div class="layui-upload">
                            <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
                                ...
                                <div class="layui-upload-list" id="goodsPreviewDiv">
                                    <img src="<%=basePath%>res/img/uploadImg.svg" alt=""
                    ...
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            <button type="button" class="layui-btn layui-btn-danger" lay-submit="" lay-filter="publishGoodsBtn" style="float: right">
                                立即发布
                            </button>
                        </div>
                    </div>
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function () {
        ...
        //监听“立即发布”按钮提交事件
        form.on('submit(publishGoodsBtn)', function (data) {
            ...
            $.ajax({
                ...
                success:function(result){
                    if(result.flag){
                        ...
                        layer.msg("发布物品失败，请稍后再试！",{icon: 5});//失败的表情
                    }
                },
        ...
        var uploadInst = upload.render({
            ...
            , before: function (obj) {//提交服务器之前
                ...
                obj.preview(function (index, file, result) {
                    //首先清空goodsPreviewDiv(这样只适合上传单图片物品，做上传多物品图片功能再看看如何修改)
            ...
            , done: function (res) {//提交服务器完成后
                ...
                if (res.status > 0) {
                    ...
                    //添加一个文件名经过处理的隐藏表单项
                    $("#goodsPreviewDiv").append('<input name="imgUrl" value="' + res.fileUrl + '" type="hidden">');
