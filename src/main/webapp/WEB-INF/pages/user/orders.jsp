...
<head>
    ...
    <script type="text/javascript">
        ...
        function ordersDeliver(orderNum) {
            ...
            location.href = '<%=basePath%>order/deliver/' + orderNum
        ...
        function ordersReceipt(orderNum, orderPrice, goodsId) {
            location.href = '<%=basePath%>order/receipt?orderNum=' + orderNum + '&orderPrice=' + orderPrice + '&goodsId=' + goodsId;
...
<div id="cover" style="min-height: 639px;">
    <div id="user_area">
        ...
        <div id="user_nav">
            ...
            <div class="home_nav">
                <ul>
                    <a href="<%=basePath%>order/myOrders">
                        <li class="buyinfo">
                            <div></div>
                            <span>订单中心</span>
                            <strong></strong>
        ...
        <div id="user_content">
            ...
            -->
                ...
                <div class="share_content">
                    <c:if test="${empty order and empty orderOfSell}">
                        <div class="no_share">
                            <span>没有任何内容，去逛逛其它的吧！</span>
                        </div>
                    </c:if>
                    <c:if test="${!empty order or !empty orderOfSell}">
                        <div class="story">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <c:if test="${items.orderState==1}">
                                                                    ...
                                                                    <input type="button" value="申请退款" class="btn btn-success"
                                                                        onclick="ordersRefund()"/>
                                                                </c:if>
                                                                <c:if test="${items.orderState==2}">
                                                                    <input type="button" value="收&nbsp&nbsp&nbsp&nbsp货"
                                                                           onclick="ordersReceipt(${items.orderNum},${items.orderPrice},${items.goods.id})" class="btn btn-info"/>
                                                                </c:if>
                                        ...
                                        <form class="form-horizontal" role="form">
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                    <c:forEach var="items" items="${orderOfSell}">
                                                        <tr>
                                                            <td>${items.orderNum}</td>
                                                            <td>
                                                                    ${items.goods.name}
                                                            ...
                                                            <td>
                                                                <c:if test="${items.orderState==1}">
                                                                    <input type="button" value="发&nbsp&nbsp&nbsp&nbsp货"
                                                                           onclick="ordersDeliver(${items.orderNum})" class="btn btn-info"/>
                                                                </c:if>
                                                                <c:if test="${items.orderState==2}">
