...
<div class="layuimini-container">
    <div class="layuimini-main">
        ...
        <script type="text/html" id="defaultAddrTpl">
            {{#  if(d.defaultAddr == 0){ }}
                    是
            {{#  } else if(d.defaultAddr == 1) { }}
                    否
            {{#  }  }}
    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
				...
				{field: 'description', width:400, title: '地址详情',edit:'text',align:'center'},
				{field: 'phone', width: 150, title: '手机号码',edit:'text',align:'center'},
				{field: 'username', width: 120, title: '收货人姓名',edit:'text',align:'center'},
				{field: 'userId', width: 120, title: '所属用户ID',align:'center'},
                {field: 'defaultAddr', width: 130, title: '是否为默认地址',templet: '#defaultAddrTpl', align:'center'},
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['60%', '80%'],
                    content: '<%=basePath%>admin/address/editPage?id=' + data.id
                });
                $(window).on("resize", function () {
                    layer.full(index);
                });
                ...
                layer.confirm('确定删除id为'+ data.id +'的地址么？', function (index) {
                    obj.del();
                    layer.close(index);
					
					$.ajax({
						url: "<%=basePath%>admin/address/delete",
						data: {id:data.id},
						type: "post",
						dataType: "json",
		...
		table.on('edit(currentTableFilter)', function(obj){
            ...
            $.ajax({
                url: "<%=basePath%>admin/address/updateField",
