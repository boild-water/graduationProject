		...
		<div class="layui-row">
			...
			<div class="layui-col-xs6" style="padding: 20px;">
			  <div>
				<!-- 填充物品图片 -->
				<div class="">
					<img id="spec-img" alt="" src="<%=basePath%>upload/goods/${goodsExtend.images[0].imgUrl}" width="490" height="400px">
				</div>
			...
			<div class="layui-col-xs6" style="padding: 20px;">
				...
				<div>
					...
					<p class="class2">
						...
						<span style="font-size: 16px;">${goodsExtend.goods.addressDesc}</span>
					</p>
				</div>
				<!-- 卖家信息 -->
